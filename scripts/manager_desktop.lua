...
function rebuildSidebar()
	...
	local tRecordTypes = RecordDataManager.getRecordTypes();
	for _,sRecordType in ipairs(tRecordTypes) do
		if not RecordDataManager.isHidden(sRecordType) then
			local sRecordCategory = RecordDataManager.getFieldData(sRecordType, "sSidebarCategory", DesktopManager.getSidebarDefaultCategoryByRecordType(sRecordType));
...
function sortSidebarAlphaWithinCategory(a,b)
	...
	if a.sRecordType then
		sLabelA = RecordDataManager.getRecordTypeDisplayText(a.sRecordType);
	...
	if b.sRecordType then
		sLabelB = RecordDataManager.getRecordTypeDisplayText(b.sRecordType);
...
function getListLink(sRecordType)
	local rRecordType = RecordDataManager.getRecordTypeData(sRecordType);
