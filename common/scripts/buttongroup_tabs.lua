...
local DEFAULT_HORIZONTAL_TEXT_OFFSETY = 10;
...
function setVisibility(bState)
	Debug.console("buttongroup_tabs:setVisibility - DEPRECATED - 2024-10-22 - Use setVisible");
	setVisible(bState);
end
